...
for matchNum in range(1, 41):
    ...
    for team in range(6):
        ...
        matchResults = (
            f'"teamNumber":{a_Teams[team][TEAMNUM]},"matchNum":{matchNum},"compLevel":"q","initials":"Python","autoMove":{autoMove},'
            f'"autoAmp":{autoAmp},"autoAmpMiss":{autoAmpMiss},'
            f'"autoSpeakerClose":{autoSpeakerClose},"autoSpeakerNotClose":{autoSpeakerNotClose},"autoSpeakerMiss":{autoSpeakerMiss},'
            f'"teleAmp":{a_Teams[team][AMP]},"teleAmpMiss":{a_Teams[team][AMPMISS]},'
            f'"teleSpeakerClose":{a_Teams[team][SPEAKERCLOSE]},"teleSpeakerNotClose":{a_Teams[team][SPEAKERNOTCLOSE]},"teleSpeakerMiss":{a_Teams[team][SPEAKERMISS]},'
            f'"telePark":{telePark},"teleClimb":{teleClimb},"teleTrap":{teleTrap},"teleTrapMiss":{teleTrapMiss},'
            f'"teleMic":{teleMic},"teleMicMiss":{teleMicMiss},'
            f'"card":0,"noShow":0,"tipped":0,"died":0,"playDefense":0,"driverSkill":{teleDriverSkill},'
            f'"comments":"{comments}"'
            )
